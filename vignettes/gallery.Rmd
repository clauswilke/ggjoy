...
The ggjoy package has been deprecated. Please switch over to [ggridges](https://CRAN.R-project.org/package=ggridges). The following materials are retained for historical reference only.
